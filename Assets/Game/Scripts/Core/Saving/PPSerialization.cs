...
public class PPSerialization : MonoBehaviour
{
    ...
    /// </summary>
    public static void Save<T>(string saveTag, T obj, bool toCloud = true)
    {
        ...
        //		Debug.Log(toCloud + " " + saveTag + ": " + json );
        ...
        //Debug.Log( saveTag + ": " + json );

        PlayerPrefs.SetString(saveTag, json);
        //Debug.Log( saveTag + "  " + json.Length + "  " + PlayerPrefs.GetString( saveTag ).Length );
